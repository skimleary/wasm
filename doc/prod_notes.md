...
GitHub does not allow font coloring, I suspect due to possible abuse.  Remember when web pages had way-out-there designs with fantastics colors, fonts (read: Comic Sans), and other styling (blink)?  I do.  The design team at GitHub obviously do, too.
...
* Slide deck generated using *Impress* (p/o `LibreOffice`)
* Document markup using `Visual Studio Code` and `MarkdownPad 2`
<pre>
